...
Note that if you edited a file (ex. a json attestation) and want to test with it, then you will have to redo the [installation](#installation) process, including cargo, Docker, and EIF building.
